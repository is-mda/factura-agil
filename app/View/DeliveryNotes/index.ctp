                    ...
                    <td class="actions">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span> ' . __('Delete'), array('action' => 'delete', $deliveryNote['DeliveryNote']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $deliveryNote['DeliveryNote']['id'])); ?></li>
                            </ul>
                        </div>                        
                    </td>
                </tr>
